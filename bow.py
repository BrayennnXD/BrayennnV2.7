...
def menu(my_name,my_id):
	...
	if _____brayennn___xd____ in ['1','01']:
		...
		cetak(panel(f"Sebentar Anda Akan Di Arahkan Menuju Link Donasi Untuk BrayennnXD Wkwwk",width=90,title=f"[bold green]Link Donasi",padding=(0,8),style=f"bold white"))
		os.system("xdg-open https://saweria.co/BrayennnXD")
		time.sleep(3)
		back()
